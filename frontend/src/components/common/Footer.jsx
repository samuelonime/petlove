...
import { 
  ...
  FaLinkedin, FaYoutube, FaArrowUp, FaHeart
} from 'react-icons/fa';
...
const Footer = () => {
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__decorative-dots"><div className="dot" /></div>
      ...
      <div className="footer__container">
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <div className="footer__logo-wrapper">
              ...
              <h3 className="footer__logo-text">PetHub</h3>
            </div>

            <p className="footer__description">
              Nigeria's premier marketplace connecting pet lovers with quality supplies,
              trusted sellers, and expert care for your beloved companions.
            </p>
            ...
            <div className="footer__newsletter">
              ...
              <div className="footer__newsletter-form">
                ...
                />
                <button className="footer__newsletter-button">Join</button>
              </div>
            </div>
          </div>
              ...
              {[
                ...
                <li key={item.label} className="footer__link-item">
                  <Link to={item.to} className="footer__link">
                    <span className="footer__link-icon">{item.icon}</span>
          ...
          <div className="footer__section">
            ...
            <ul className="footer__links">
              {[
                ...
                <li key={item.label} className="footer__link-item">
                  <Link to={item.to} className="footer__link">
                    <span className="footer__link-bullet" />
                    <span>{item.label}</span>
                  </Link>
                </li>
              ))}
          ...
          <div className="footer__section">
            ...
            <div className="footer__social-section">
              ...
              <div className="footer__social-icons">
                {[
                  { href: '#', cls: 'facebook',  icon: <FaFacebook />  },
                  { href: '#', cls: 'twitter',   icon: <FaTwitter />   },
                  { href: '#', cls: 'instagram', icon: <FaInstagram /> },
                  { href: '#', cls: 'linkedin',  icon: <FaLinkedin />  },
                  { href: '#', cls: 'youtube',   icon: <FaYoutube />   },
                  { href: '#', cls: 'whatsapp',  icon: <SiWhatsapp />  },
                ].map(s => (
                  <a key={s.cls} href={s.href}
                    className={`footer__social-link footer__social-link--${s.cls}`}
                    aria-label={s.cls}>
                    {s.icon}
                  </a>
                ))}
            ...
            <div className="footer__app-downloads">
              ...
              <div className="footer__app-buttons">
                <button className="footer__app-button footer__app-button--appstore">
                  <svg className="footer__app-icon" viewBox="0 0 24 24" fill="none">
                    <path d="M17.05 20.28C16.07 21.23 15 21.08 13.97 20.63C12.88 20.17 11.88 20.15 10.73 20.63C9.29 21.25 8.53 21.07 7.66 20.28C2.86 15.25 3.71 7.08 9.92 6.79C11.22 6.83 12.11 7.45 12.9 7.52C13.99 7.26 15.05 6.66 16.2 6.73C17.63 6.83 18.67 7.33 19.42 8.37C15.82 10.53 16.72 15.05 20.1 16.2C19.45 17.78 18.62 19.33 17.04 20.29L17.05 20.28ZM12.03 6.75C11.85 4.05 14.08 1.85 16.63 2C17.02 4.44 14.37 6.3 12.03 6.75Z" fill="currentColor"/>
                  </svg>
                  <span>App Store</span>
                </button>
                <button className="footer__app-button footer__app-button--playstore">
                  <svg className="footer__app-icon" viewBox="0 0 24 24" fill="none">
                    <path d="M3 20.4V3.6C3 3.27 3.27 3 3.6 3H20.4C20.73 3 21 3.27 21 3.6V20.4C21 20.73 20.73 21 20.4 21H3.6C3.27 21 3 20.73 3 20.4Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M15.2 12L9 8V16L15.2 12Z" fill="currentColor" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
                  </svg>
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__trust-badges">
            {[
              { cls: 'secure',   icon: '✓', label: 'Secure Payments'  },
              { cls: 'escrow',   icon: '✓', label: 'Escrow Protected'  },
              { cls: 'verified', icon: '★', label: 'Verified Sellers'  },
              { cls: 'delivery', icon: '✓', label: 'Fast Delivery'     },
            ].map(b => (
              <div key={b.cls} className="footer__trust-badge">
                <div className={`footer__trust-icon footer__trust-icon--${b.cls}`}>{b.icon}</div>
                <div className="footer__trust-label">{b.label}</div>
              </div>
            ))}
          </div>
        </div>
